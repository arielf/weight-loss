...
- High fat: I switched from milk to half-and-half.  Avocados, olive oil, mayo, coconut oil, etc.  Never worry about *natural* fat, you can eat as much as you want of it. This is what makes it much easier to avoid carbs because you can stuff yourself with fat and feel much less hungry and miss the carbs less. The beautiful thing is that the body is very good at figuring out "I have too much fat in the blood, so let's increase the amount of enzymes which break-up fat" and this makes you lose weight in the long run.  Most importantly never buy any product saying "low fat" or "fat free" on it, the food industry usually replaces the fat with sugar (so it tastes better, otherwise it tastes awful). You often hear about bad vs good fat: as long as it is natural, it is ok (Trans-fat isn't natural, it is hydrogenated by the food industry). And the less saturated it is, the better, mono-saturated (plant) fat is the best, then the poly-unsaturated fats, and finally near saturated (but not fully saturated) fats that come from animals. Thick Margarine: no; Earth Balance: yes.
